export const PROFILE = {
  first: "Bharath",
  last: "Kumar Reddy",
  handle: "bharath-kumar-reddy",
  fullName: "Bharath Kumar Reddy Mukthapuram",
  ...
  socials: [
    ...
    { label: "LinkedIn", href: "#" },
    { label: "Email", href: "https://mail.google.com/mail/?view=cm&fs=1&to=mukthapurambharathkumarreddy@gmail.com" },
  ],
  tagline: [
    "I build interfaces",
    "that feel — ",
...
export const CHAPTERS = [
  {
    ...
    title: "Principles",
    body:
      "Interfaces are not decoration — they are the shortest sentence between a person and their intent. I write them with restraint.",
  },
  {
    n: "02",
    title: "Craft",
    body:
      "React and JavaScript on the surface. PostgreSQL and Express beneath. I care equally about a 40ms interaction and a well-named column.",
  },
  {
    n: "03",
    title: "Cadence",
    body:
      "Ship weekly. Refactor Sundays. Read the docs before the tutorial. Every project should teach me something my last one couldn't.",
  },
  {
    n: "04",
    title: "Curiosity",
    body:
      "From MATLAB image processing on brain scans to production React sites for real clients — I follow the interesting problem.",
  },
];
